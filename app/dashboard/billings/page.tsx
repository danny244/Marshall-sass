          ...
          const session = await stripe.billingPortal.sessions.create(
               {
                    ...
                    return_url: process.env.NODE_ENV == "production" ? process.env.PRODUCTION_URL as string : "http://localhost:3000", // where we will return to after this customer portal
               }
          )
